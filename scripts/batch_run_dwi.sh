...
# ============================================================
# ADS DWI Batch Pipeline Runner
# ============================================================

# Default paths (relative to OpenADS folder)
DEFAULT_SUBJECTS_ROOT="assets/examples/dwi"
DEFAULT_GPU="1"
...
show_help() {
    echo "==========================================================="
    echo "ADS DWI Batch Pipeline Runner"
    echo "==========================================================="
    echo ""
    echo "Usage: $0 [OPTIONS]"
    echo ""
    echo "Batch process DWI subjects."
    echo ""
    ...
    echo "                          Available: prepdata, gen_mask, skull_strip,"
...
if [[ -n "$SUBJECTS_FILE" ]]; then
    ...
    # Check for subfolders matching pattern
...
process_subject() {
    ...
    # NOTE: Using run_ads_dwi.py here
    python3 "$OPENADS_ROOT/scripts/run_ads_dwi.py" "${python_args[@]}"
